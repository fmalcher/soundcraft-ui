import { DBToFaderValueCALC, faderValueToDBCALC } from './value-converters';
...
describe('Value converters', () => {
  it('should convert linear value to dB value', () => {
    ...
    expect(faderValueToDBCALC(0.7379774276050739)).toMatchInlineSnapshot(
      `-0.9`
    );
    expect(faderValueToDBCALC(0.7115203608991578)).toMatchInlineSnapshot(
      `-1.9`
    );
    expect(faderValueToDBCALC(0.6855889220023528)).toMatchInlineSnapshot(
      `-2.9`
    );
    expect(faderValueToDBCALC(0.612728497479111)).toMatchInlineSnapshot(`-5.9`);
    expect(faderValueToDBCALC(0.5487738897791132)).toMatchInlineSnapshot(
      `-8.9`
    );
    expect(faderValueToDBCALC(0.4933368943165988)).toMatchInlineSnapshot(
      `-11.9`
    );
    expect(faderValueToDBCALC(0.4450032153399661)).toMatchInlineSnapshot(
      `-14.9`
    );
    expect(faderValueToDBCALC(0.4023566844407469)).toMatchInlineSnapshot(
      `-17.9`
    );
    expect(faderValueToDBCALC(0.37650583661161363)).toMatchInlineSnapshot(
      `-19.9`
    );
    expect(faderValueToDBCALC(0.2693554200232029)).toMatchInlineSnapshot(
      `-29.9`
    );
    expect(faderValueToDBCALC(0.11764705926179886)).toMatchInlineSnapshot(
      `-49.9`
    );
    expect(faderValueToDBCALC(0.05882352590560913)).toMatchInlineSnapshot(
      `-59.9`
    );
    expect(faderValueToDBCALC(0.025155186653137207)).toMatchInlineSnapshot(
      `-69.9`
    );
    expect(faderValueToDBCALC(0.010385841131210327)).toMatchInlineSnapshot(
      `-79.9`
    );
    expect(faderValueToDBCALC(0.003787517547607422)).toMatchInlineSnapshot(
      `-89.9`
    );
    expect(faderValueToDBCALC(0.001269415020942688)).toMatchInlineSnapshot(
      `-99.9`
    );
  ...
  it('should convert dB value to linear value', () => {
    ...
    expect(DBToFaderValueCALC(-20)).toMatchInlineSnapshot(
      `0.37650583661161363`
    );
    expect(DBToFaderValueCALC(-30)).toMatchInlineSnapshot(`0.2693554200232029`);
    expect(DBToFaderValueCALC(-50)).toMatchInlineSnapshot(
      `0.11764705926179886`
    );
    expect(DBToFaderValueCALC(-60)).toMatchInlineSnapshot(
      `0.05882352590560913`
    );
    expect(DBToFaderValueCALC(-70)).toMatchInlineSnapshot(
      `0.025155186653137207`
    );
    expect(DBToFaderValueCALC(-80)).toMatchInlineSnapshot(
      `0.010385841131210327`
    );
    expect(DBToFaderValueCALC(-90)).toMatchInlineSnapshot(
      `0.003787517547607422`
    );
    expect(DBToFaderValueCALC(-100)).toMatchInlineSnapshot(
